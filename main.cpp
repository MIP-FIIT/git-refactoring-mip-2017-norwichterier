...
void odmeny(FILE *subor)
{
	...
	long int zadany_datum,datum_zo_zaznamu,pocet_zaznamov,pocet_riadkov;
	float odmena;
	
	scanf("%li",&zadany_datum);	
	pocet_riadkov=zrataj_riadky(subor)	;
...
void spz (char*pole_SPZ,FILE *subor)
{
	...
	{
	printf("%c",*(pole_SPZ+poradie_znaku));																			
